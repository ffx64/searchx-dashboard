  ...
  const systems = [
    {
      ...
      storage: 34,
      uptime: "68 days",
      location: "EXCON DATA CENTER - DOCKER CONTAINER",
      lastMaintenance: "2025-07-23",
    },
    {
      id: "SYS-002",
      name: "DATABASE GENERAL",
      type: "Database",
      status: "online",
      health: 95,
      cpu: 72,
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-background hover:bg-secondary border hover:border-muted-foreground text-muted-foreground hover:text-white">System Scan</Button>
          <Button className="bg-background hover:bg-secondary border hover:border-muted-foreground text-muted-foreground hover:text-white">Maintenance Mode</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-muted">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-400 tracking-wider">SYSTEMS ONLINE</p>
        ...
        <Card className="bg-muted">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-400 tracking-wider">WARNINGS</p>
                <p className="text-2xl font-bold text-purple-400 font-mono">3</p>
              </div>
        ...
        <Card className="bg-muted">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-400 tracking-wider">AVG UPTIME</p>
        ...
        <Card className="bg-muted">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-400 tracking-wider">MAINTENANCE</p>
                <p className="text-2xl font-bold text-gray-300 font-mono">1</p>
              </div>
      ...
      {/* System Detail Modal */}
      {selectedSystem && (
        <Dialog open={true} onOpenChange={() => setSelectedSystem(null)}>
          <DialogContent className="bg-muted font-mono w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-300 tracking-wider mb-2">SYSTEM STATUS</h3>
                    <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-gray-300 tracking-wider mb-2">SYSTEM INFORMATION</h3>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-300 tracking-wider mb-2">RESOURCE USAGE</h3>
                    <div className="space-y-3">
                      {["cpu", "memory", "storage"].map((res) => (
                        <div key={res}>
                          <div className="flex justify-between text-sm mb-1">
                            <span className="text-gray-400">
                              {res.charAt(0).toUpperCase() + res.slice(1)} Usage
                            </span>
                          ...
                          <div className="w-full bg-gray-800 rounded-full h-2">
                            <div
                              ...
                              style={{ width: `${selectedSystem[res]}%` }}
                            ></div>
                          </div>
                        </div>
                      ))}
              ...
              <div className="flex gap-2 pt-4 border-t">
                <Button className="bg-white text-black">Restart System</Button>
                <Button
                  variant="outline"
